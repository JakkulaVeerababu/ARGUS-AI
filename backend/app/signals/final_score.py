...
class BusinessScorer:
    ...
    def score_candidates(self, ce_results: List[Tuple[str, float]], top_n: int = 100) -> List[Dict[str, Any]]:
        """
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nScoring Results:")
        for r in results:
            print(f"  {r['candidate_id']} - CE: {r['cross_encoder_score']:.2f} -> Sigmoid: {r['sigmoid_ce_score']:.4f} -> Final: {r['final_score']:.4f}")
