...
TITLE_VOCABULARY = {
    ...
    "deep learning engineer", "software engineer", "backend engineer", 
    "search engineer", "recommendation engineer", "data engineer", "qa engineer",
    "systems engineer", "full stack developer", "applied ml engineer", "developer"
}
