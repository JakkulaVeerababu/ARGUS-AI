...
SKILL_ALIASES = {
    "pytorch": ["torch"],
    "tensorflow": ["tf"],
    "retrieval": ["semantic search", "embeddings-based retrieval", "information retrieval"],
    "fastapi": ["rest api", "web api"],
    "vector search": ["faiss", "vector database", "pinecone", "milvus", "qdrant", "weaviate"],
    "machine learning": ["ml", "deep learning"]
}

# Baseline technical terms dictionary
MUST_HAVE_KEYS = {
    "python", "faiss", "bm25", "vector search", "retrieval", "embeddings", 
    "nlp", "ndcg", "mrr", "map", "evaluation", "machine learning"
}

NICE_TO_HAVE_KEYS = {
    "docker", "aws", "gcp", "mlflow", "mlops", "bento_ml", "fine-tuning", 
    "lora", "qlora", "peft", "distributed systems", "xgboost", "lightgbm", 
