...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.critical(f"Lifespan Startup: Critical failure in ModelRegistry initialization: {e}")
    ...
    try:
        ...
        dummy_query = "Python developer with experience in machine learning and faiss search"
        ...
        logger.warning(f"Lifespan Startup: Mock queries failed to complete ({e}). Proceeding to startup.")
    ...
    try:
        ...
        if registry._sqlite_manager:
            ...
            logger.info("Lifespan Shutdown: SQLite database connection closed successfully.")
    except Exception as e:
