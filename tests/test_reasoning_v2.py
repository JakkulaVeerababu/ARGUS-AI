...
def test_reason_builder_v2_word_count_limits():
    ...
    reason = build_candidate_reasoning_v2(
        candidate_minimal, rank=1, parsed_jd=parsed_jd
    )
    words = reason.split()
    ...
    reason_ext = build_candidate_reasoning_v2(
        candidate_extensive, rank=1, parsed_jd=parsed_jd_ext
    )
